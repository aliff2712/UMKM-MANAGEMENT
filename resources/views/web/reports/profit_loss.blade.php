            ...
            <table class="custom-table" style="font-size: 0.95rem;">
                <tbody>
                    ...
                    <tr style="border-bottom: 2px solid var(--glass-border);">
                        ...
                        <td class="text-right font-bold text-success">Rp {{ number_format($income, 0, ',', '.') }}</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-right text-error">-Rp {{ number_format($cogs, 0, ',', '.') }}</td>
                    </tr>
                    <tr style="border-bottom: 2px solid var(--glass-border);">
                        <td style="padding-left: 32px; font-weight: bold;">TOTAL HARGA POKOK PENJUALAN (HPP)</td>
                        <td class="text-right font-bold text-error">Rp {{ number_format($cogs, 0, ',', '.') }}</td>
                    </tr>
                    ...
                    <tr style="background: rgba(255,255,255,0.04); border-bottom: 2px solid var(--glass-border); font-size: 1.05rem;">
                        ...
                        <td class="text-right font-bold text-cyan">
                            ...
                            <span style="font-size: 0.8rem; color: var(--text-muted); font-weight: normal; margin-left: 6px;">(Margin: {{ number_format($grossMargin, 1) }}%)</span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-right text-error">-Rp {{ number_format($expenses, 0, ',', '.') }}</td>
                    </tr>
                    <tr style="border-bottom: 2px solid var(--glass-border);">
                        <td style="padding-left: 32px; font-weight: bold;">TOTAL BIAYA OPERASIONAL (BIAYA KAS)</td>
                        <td class="text-right font-bold text-error">Rp {{ number_format($expenses, 0, ',', '.') }}</td>
                    </tr>
                    ...
                    <tr style="background: rgba(139, 92, 246, 0.12); font-size: 1.15rem; border: 2px solid {{ $isProfit ? 'var(--success)' : 'var(--error)' }};">
                        ...
                        <td class="text-right font-bold {{ $isProfit ? 'text-success' : 'text-error' }}">
                            ...
                            <span style="font-size: 0.85rem; color: var(--text-muted); font-weight: normal; margin-left: 6px;">(Margin: {{ number_format($netMargin, 1) }}%)</span>
                        </td>
                    </tr>
                </tbody>
            </table>
