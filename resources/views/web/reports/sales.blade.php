...
<div class="glass-card mb-6">
    <form action="{{ route('reports.sales') }}" method="GET" class="report-filter-form" id="filter-form">
    ...
    <form id="export-form" action="{{ route('reports.sales.export') }}" method="POST" style="display: none;">
        @csrf
...
<div class="stat-grid">
    ...
    <div class="glass-card stat-card success">
        ...
        <div class="stat-card-value text-success"> {{ number_format($productSales->sum('total_qty'), 0, ',', '.') }}</div>
    ...
    <div class="glass-card stat-card primary">
        ...
        <div class="stat-card-value text-primary"> {{ number_format($summary['total_transactions'] ?? 0, 0, ',', '.') }}</div>
