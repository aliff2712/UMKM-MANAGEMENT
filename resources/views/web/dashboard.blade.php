...
<div class="stat-grid">
    ...
    <div class="glass-card stat-card {{ $isProfit ? 'success' : 'error' }}">
        ...
        <div class="stat-card-desc">
            <i data-lucide="{{ $isProfit ? 'smile' : 'frown' }}"
    ...
    <div class="glass-card">
        ...
        <div style="text-align:center;padding:32px;color:var(--text-muted);">
            ...
            <i data-lucide="check-circle"
                style="width:48px;height:48px;margin-bottom:12px;color:var(--success);">
            </i>
        ...
        <table class="custom-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right">
                        <strong>{{ $dp['current_sales'] }}</strong>
                    </td>

                    <td class="text-right text-error font-bold">
                        -{{ number_format($dp['drop_percentage'], 1) }}%
                    </td>
